  ...
  return (
    <div className="min-h-screen bg-white px-6 py-24 text-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          <div className="text-center py-20 text-lg text-blue-600 font-semibold">
            Loading your vault items...
          </div>
        ) : vaultItems.length === 0 ? (
          <div className="text-center text-gray-500">No vault items found.</div>
        ) : (
          <div className="flex flex-col gap-10">
            {vaultItems.map((item) => (
              <div
                key={item.id}
                className="border border-blue-100 bg-blue-50 p-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6">
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-4">
                      <h2 className="text-2xl font-bold text-blue-900">{item.title}</h2>
                      <span className="text-xs px-3 py-1 rounded-full bg-blue-200 text-blue-900 font-medium">
                        {item.accessLevel}
                      </span>
                    </div>
                    ...
                    <div className="mt-6 flex gap-4">
                      ...
                      <button className="bg-red-100 text-red-600 px-4 py-2 rounded-md text-sm hover:bg-red-200 transition">
                        Delete
                      </button>
                    </div>
                  </div>
                  ...
                  <AnimatePresence>
                    {selectedItemId === item.id && (
                      <motion.div
                        ...
                        className="w-full lg:w-[40%] bg-gray-900 text-green-400 p-6 rounded-xl overflow-x-auto shadow-inner"
                      >
        ...
        <div className="mt-20 border-t pt-10 text-center text-gray-500 text-sm">
