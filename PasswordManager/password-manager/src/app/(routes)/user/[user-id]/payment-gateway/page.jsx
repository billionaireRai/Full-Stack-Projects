...
export default function UserPaymentGateway() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 px-4 pt-24 pb-20 text-gray-800 dark:text-gray-100">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Left: Plan Summary */}
          <div className="bg-blue-50 dark:bg-blue-900 p-6 rounded-xl shadow-sm border-none">
            <h2 className="text-2xl font-semibold text-blue-900 dark:text-blue-300 mb-1">{plan.name} Plan</h2>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-6">🔐 Payment Details</h3>
            <form className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="transition-all duration-300 w-full rounded-md border border-gray-300 dark:border-gray-600 p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
                />
              </div>
              <div>
        ...
        <div className="mt-16 text-center space-y-6">
          ...
          <div className="flex justify-center flex-wrap gap-4">
            <button className="cursor-pointer bg-red-100 text-red-600 dark:bg-red-900 dark:text-red-400 px-5 py-2 rounded-md hover:bg-red-200 dark:hover:bg-red-800 transition">
              Cancel Payment
            </button>
            <button className="cursor-pointer bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300 px-5 py-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition">
              Contact Support
            </button>
            <button className="cursor-pointer bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-400 px-5 py-2 rounded-md hover:bg-green-200 dark:hover:bg-green-800 transition">
              Change Plan
            </button>
          </div>
        </div>
