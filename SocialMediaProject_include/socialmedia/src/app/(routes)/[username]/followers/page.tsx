  ...
  return (
    ...
    <div className='m-2'>
      ...
      <div className="follow-suggestions flex-1 rounded-md p-2">
        <div className="heading flex flex-row items-center gap-4 rounded-md font-bold p-3"><span>Can add in followings</span><ThumbsUp size={18} className='fill-black dark:fill-white' /></div>
        <div>
          <Usercard/>
          <Usercard/>
          <Usercard/>
