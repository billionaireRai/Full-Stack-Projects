...
export default function SignUp() {
  ...
  const handleSignUpLogic = async (data: z.infer<typeof signUpDataType>) : Promise<string> => {
    ...
    if (apiRes.status === 200) {
      ...
      await generateKeyPairAndStoreBoth(apiRes.data.userCred.accountId); // for public-private key generation...
  ...
  return (
    <div className="w-screen h-screen flex flex-col-reverse md:flex-row font-poppins overflow-hidden p-4 bg-white dark:bg-black dark:bg-none">
      {/* Left Section - Form */}
      <div className="flex flex-col justify-center items-center w-full lg:w-1/2 bg-white dark:bg-black">
        <div className="flex flex-col items-center text-center">
          <Image
            ...
            className="mt-10 rounded-full dark:invert"
          />
        ...
        className="w-full max-w-lg bg-white p-6 my-10 mx-5 rounded-xl shadow-xl dark:shadow-2xl dark:shadow-gray-950 border border-gray-200 dark:bg-black dark:border-gray-700">
          <div className="mb-4">
            <label className="block text-sm text-black mb-1 dark:text-white">Name</label>
            <div className="flex items-center border border-gray-300 rounded-md group px-3 transition-all duration-300 focus-within:border-yellow-500 focus-within:ring-3 focus-within:ring-yellow-200 dark:focus-within:border-yellow-500 dark:focus-within:ring-4 dark:focus-within:ring-yellow-600/50 dark:border-gray-600">
              <User className="text-gray-500 mr-2 w-5 h-5 group-focus-within:stroke-amber-400 dark:group-focus-within:stroke-yellow-400 dark:stroke-white" />
              <input
                type="text"
                {...register('Name')}    
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center border border-gray-300 rounded-md group px-3 transition-all duration-300 focus-within:border-yellow-500 focus-within:ring-3 focus-within:ring-yellow-200 dark:focus-within:border-yellow-500 dark:focus-within:ring-4 dark:focus-within:ring-yellow-600/50 dark:border-gray-600">
              <AtSign className="text-gray-500 mr-2 w-5 h-5 group-focus-within:stroke-amber-400 dark:group-focus-within:stroke-yellow-400 dark:stroke-white" />
              <input
                type="text"
                {...register('Username')}
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center border border-gray-300 rounded-md group px-3 transition-all duration-300 focus-within:border-yellow-500 focus-within:ring-3 focus-within:ring-yellow-200 dark:focus-within:border-yellow-500 dark:focus-within:ring-4 dark:focus-within:ring-yellow-600/50 dark:border-gray-600">
              <Mail className="text-gray-500 mr-2 w-5 h-5 group-focus-within:stroke-amber-400 dark:group-focus-within:stroke-yellow-400 dark:stroke-white" />
              <input
                type="email"
                {...register('Email')}
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center border border-gray-300 rounded-md group px-3 transition-all duration-300 focus-within:border-yellow-500 focus-within:ring-3 focus-within:ring-yellow-200 dark:focus-within:border-yellow-500 dark:focus-within:ring-4 dark:focus-within:ring-yellow-600/50 dark:border-gray-600">
              <Lock className="text-gray-500 mr-2 w-5 h-5 group-focus-within:stroke-amber-400 dark:group-focus-within:stroke-yellow-400 dark:stroke-white" />
              <input
                type="password"
                {...register('Password')}
          ...
          <button
            ...
            type="submit"
            className="w-full cursor-pointer border-none py-3 my-3 rounded-lg bg-yellow-300 hover:bg-yellow-300 transition-all duration-300 font-semibold text-gray-900 shadow-yellow-400 hover:shadow-sm dark:bg-yellow-400 dark:hover:bg-yellow-500
             dark:shadow-lg dark:shadow-yellow-800/50 dark:text-white"
          >
            Create Account
          </button>
          ...
          <p className="text-sm text-gray-600 mt-4 flex items-center justify-center flex-row gap-3 dark:text-gray-400">
              ...
              <Link
                href="/auth/log-in"
                className="text-yellow-500 hover:text-yellow-600 font-medium transition-colors dark:text-yellow-500"
              >
                LOGIN
              </Link>
          </p>
      ...
      <div className="flex flex-col md:flex-row-reverse w-full h-screen lg:w-1/2 justify-center items-center bg-contain bg-white dark:bg-black dark:bg-none">
